...
pkm <- SklearnEls()$skcl$KMeans(n_clusters = 7L)$fit(pypca)
Python_KMeans_PCA <- pkm$predict(pypca)
...
pmbk <- SklearnEls()$skcl$MiniBatchKMeans(n_clusters = 7L)$fit(pypca)
Python_MBK_PCA <- pmbk$predict(pypca)
